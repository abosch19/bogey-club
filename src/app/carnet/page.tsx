...
export default async function CarnetPage() {
  ...
  if (completedRoundIds.length > 0) {
    ...
    bestScore = totals.length > 0 ? Math.min(...totals) : null
  }
    ...
    <div className="min-h-screen bg-[#f4f1e9] pb-28">
      <div style={{ paddingTop: 'max(54px, env(safe-area-inset-top))' }}>
        ...
        <div className="px-[14px] space-y-3">
            ...
            <div className="relative">
              ...
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  ...
                  <p className="text-[#6b7a72] text-[12px] mt-0.5">{user.email}</p>
                </div>
              </div>
          ...
          {last5.length > 0 && (
            <div>
              <h3 className="text-[#0e1a16] text-[14px] font-bold px-1 mb-2">Últimas 5 rondas</h3>
