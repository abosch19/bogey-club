          ...
          <div className="bg-white rounded-[16px] border border-[#e5e0d4] p-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="w-9 h-9 rounded-full flex items-center justify-center text-[18px] text-white"
          ...
          <div className="bg-white rounded-[16px] border border-[#e5e0d4] p-4">
            ...
            <div className="space-y-2">
              {MODES.map(m => (
                ...
                >
                  <div>
                    <p className="font-semibold text-[14px]" style={{ color: mode === m.id ? '#fff' : '#0e1a16' }}>
                      {m.name}
                    </p>
                    <p
