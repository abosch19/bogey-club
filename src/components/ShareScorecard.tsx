...
export function ShareScorecardButton({ courseName, dateLabel, holesLabel, groups, players, getScore }: ShareScorecardButtonProps) {
  ...
  return (
    <button type="button" onClick={handleShare} disabled={busy} aria-label="Compartir tarjeta"
      ...
      {busy ? (
        ...
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
          <path d="M12 3v12M12 3l-4 4M12 3l4 4" stroke="#6b7a72" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-7" stroke="#6b7a72" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      )}
    </button>
  )
